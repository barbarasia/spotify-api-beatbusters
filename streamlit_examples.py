...
st.header('This is freakin coool, dude!')
st.write('lalala')
...
# # #### Select box
select_box = st.selectbox('Happy it is Friday today?', ['Yes', 'No', 'Maybe'])
...
chart_data = pd.DataFrame( np.random.randn(10, 4), columns=[f"Col{i+1}" for i in range(4)] )
st.write(chart_data)
...
track_preview = 'https://p.scdn.co/mp3-preview/faad7dce8e7deeb059c7c59645c594c40342812f?cid=c57cd53cfd2a4af98f7969585645caea'
